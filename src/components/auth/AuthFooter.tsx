  ...
  return (
    <div className={"w-full pt-[28px] pb-[8px] border-t border-t-[#8080804D]"}>
      {{
        ...
        <div
          className={`text-[#101B28] ${AUTH_FOOTER_LIST_CLASSES} flex justify-center`}
        >
      ...
      <div className={"flex justify-center mt-[4px] mb-[8px]"}>
        <ul className={"list-none flex items-center"}>
          ...
          {{
            ...
            <div className={`${AUTH_FOOTER_LIST_CLASSES} text-[#101B28]`}>
              և
            </div>
          )}
          <li className={`text-[#1376DD]  ${AUTH_FOOTER_LIST_CLASSES}`}>
      ...
      <div
        className={
          "text-[#ABABAB] text-center text-[10px] font-mardoto font-normal"
        }
      >
